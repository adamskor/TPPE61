function [p, f, fIter, e_p] = LevenbergFuncGeneral(func, p0, target, S0, K , TTM)
...
[f_p, J_p] = func(p, S0, K , TTM); %f_p: n x 1, J_p: n x m
...
g = J_p'*e_p; %m x 1
stop = 0; eps1 = 10e-40; eps2 = 10e-40; eps3 = 10e-40;
if norm(g, 'inf') <= eps1
    stop = 1;
...
while ~stop && k < 100
    ...
    while true
        ...
        if norm(delta_p, 2) <= eps2*norm(p, 2)
            ...
            [f_p_new, J_p_new] = func(p_new, S0, K , TTM);
